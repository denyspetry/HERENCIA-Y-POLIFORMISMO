package org.example.Autobusito;
...
public class Bus {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int b = 0; // POSICIÓN DEL SEGUNDO AUTOBÚS
        ...
        if (a >= TAM){
            System.out.println("HA GANADO MARC");
        } else {
            System.out.println("HA GANADO PECCO");
        }
    }
    ...
    public static String dibujarCarrera(int n1, int n2) {
        ...
        sb.append(" ".repeat(n1)).append("| _ | _ | _ | _ | ___ ").append("".repeat(TAM - n1)).append("\n");
        ...
        sb.append(" ".repeat(n2)).append("| _ | _ | _ | _ | ___ ").append("".repeat(TAM - n2)).append("\n");
        sb.append(" ".repeat(n2)).append("|       BAGNAIA      |").append("".repeat(TAM - n2)).append("\n");
